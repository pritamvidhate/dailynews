...
export class News extends Component {
  ...
  handlePreviousClick = async () => {
    ...
    // &category=${this.props.category}&apikey=599db35d233f4d00944e4b0cab4f986a&page=${this.state.page - 1}&pageSize= ${this.props.pageSize}`;
  ...
  handleNextClick = async () => {
    ...
    //     let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}
    //         &apikey=599db35d233f4d00944e4b0cab4f986a&page=${this.state.page + 1}&pageSize= ${this.props.pageSize}`;
    //     this.setState({loading:true});
    //     let data = await fetch(url);
    //     let parsedData = await data.json();
    //     this.setState({
